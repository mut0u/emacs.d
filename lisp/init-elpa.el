...
;;;(add-to-list 'package-archives `("melpa" . ,(if sanityinc/no-ssl "http://elpa.zilongshanren.com/melpa/" "https://melpa.org/packages/")))

(add-to-list 'package-archives `("melpa" . ,(if (< emacs-major-version 24) "http://melpa.org/packages/" "http://elpa.zilongshanren.com/melpa/")))
